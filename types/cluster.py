...
class Cluster:
    ...
    def deploy_cluster_gcp(project): 
        ...
        machine_image = get_image_from_family(
            project=self.image_project, family=self.image_family
        )
        ...
        create_managed_instance_group(project.project_id, project.zone, self.cluster_name, template.name)
        ...
        create_couchbase_cluster(project.project_id, zone, self.cluster_name, self.cluster_username, self.cluster_password)
